...
static void
editor_source_file_loader_load_cb (GObject      *object,
                                   GAsyncResult *result,
                                   gpointer      user_data)
{
  ...
  g_assert (GTK_SOURCE_IS_FILE_LOADER (object));
...
editor_source_file_loader_load (GtkSourceFileLoader *loader,
                                int                  io_priority,
                                EditorProgress      *progress)
{
  ...
  gtk_source_file_loader_load_async (loader,
                                     ...
                                     g_object_unref,
                                     editor_source_file_loader_load_cb,
                                     dex_ref (promise));
